...
<%
	...
	ArrayList<BoardDTO> list = Bdao.BoardUserList(ssaid, start, end);
%>

	<!-- 총 게시물 수 구하기 -->
	<sql:query var="rs" dataSource="${ds}">
	select count(*) as totalcnt from userboard_tbl where id=?
...
<head>
<meta charset="UTF-8">
<title>AdminBoardList(관리자 글목록)</title>
</head>
<body>
<article>
<!--글 & 댓글 목록 탭-->
<ul class="nav nav-tabs">
  <li class="nav-item">
     <a class="nav-link active" href="AdminBoardList.jsp?<%=paging3%>">작성글 목록</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" style="color: #ea868f;" href="AdminCommentList.jsp?<%=paging3%>">작성 댓글 목록</a>
  </li>
</ul>
...
<table class="table table-hover" style="width: 950px;">
  <thead>
    <tr>
      ...
      <th scope="col" style="width: 55%; text-align: left;">글제목</th>
