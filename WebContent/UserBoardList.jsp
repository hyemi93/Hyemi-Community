...
<%
	...
	ArrayList<BoardDTO> list = Bdao.BoardUserList(ssid, start, end);
%>
...
<head>
<meta charset="UTF-8">
<title>UserBoardList(회원 글목록)</title>
</head>
<body>
<article>
<!--글 & 댓글 목록 탭-->
<ul class="nav nav-tabs">
  <li class="nav-item">
     <a class="nav-link active" href="UserBoardList.jsp?<%=paging3%>">작성글 목록</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" style="color: #ea868f;" href="UserCommentList.jsp?<%=paging3%>">작성 댓글 목록</a>
  </li>
</ul>
